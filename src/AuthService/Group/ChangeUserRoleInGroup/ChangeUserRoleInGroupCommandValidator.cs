...
public class ChangeUserRoleInGroupCommandValidator : AbstractValidator<ChangeUserRoleInGroupCommand>
{
    public ChangeUserRoleInGroupCommandValidator(AuthDbContext dbContext)
    {
        RuleFor(x => x)
