...
public static class ConnectionsModule
{
    ...
    /// <returns></returns>
    public static IServiceCollection ConfigureConnections(this IServiceCollection services, IConfiguration configuration)
    {
        services
    ...
    private static IServiceCollection ConfigureStorageProvider(this IServiceCollection services, IConfiguration configuration)
    {
