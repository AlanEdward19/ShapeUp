...
public class GetFollowersQueryHandler(DatabaseContext context,IFollowerGraphRepository graphRepository) : IHandler<IEnumerable<ProfileBasicInformationViewModel>, GetFollowersQuery>
{
    /// <summary>
